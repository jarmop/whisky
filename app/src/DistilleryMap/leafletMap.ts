...
const MAPBOX_ACCESS_TOKEN = 'pk.eyJ1IjoiamFybW9wIiwiYSI6ImNrOW8xM2lxNzAxbmYzbHJ5a200aXNjeGYifQ.HcClAUYB_z8izQnQS3TQ5A';
...
export default function drawMap(containerId: string) {
    const mymap = L.map(containerId).setView([CENTER_LATITUDE, CENTER_LONGITUDE], 7);
